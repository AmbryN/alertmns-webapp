...
import { loadNotifications, loadNotificationsFailure, loadNotificationsSuccess, markNotificationsAsSeen, markNotificationsAsSeenFailure, markNotificationsAsSeenSuccess } from './notification.action';
...
export const notificationReducer = createReducer(
  ...
  on(markNotificationsAsSeen, (state, { channelId }) => ({
    ...state,
    status: 'loading',
  })),
